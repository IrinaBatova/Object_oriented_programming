...
class Order(BaseCategoryOrder):
    ...
    def __init__(self, name, description, product_obj, quantity_order):
    ...
    def __repr__(self) -> str:
        ...
        :return: Строку (str)
        """
        # return (f"{self.__class__.__name__}('{self.name}', '{self.description}', {self.product_obj}, {self.quantity_order},"
        #         f" '{self.final_cost}')")
        return (f"{self.__class__.__name__}('{self.name}', '{self.description}', {self.product_obj},"
    ...
    def __str__(self) -> str:
        ...
        :return: Строку (str)
        """
        return (f"{self.name}, {self.description}, Наименование товара: {self.product_obj.name},"
